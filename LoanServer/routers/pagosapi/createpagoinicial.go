...
func (o * PagosAPI) createPagoInicial(c *gin.Context){
	var objC pa.CreatePagoInicialClient
	var objS pa.CreatePagoInicialServer
	...
	ret := pagos.CtrlCreatePagoInicial(&objC)
